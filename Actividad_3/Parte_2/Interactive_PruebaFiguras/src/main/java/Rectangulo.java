...
public class Rectangulo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese la base del rectángulo");

        jLabel3.setText("Ingrese la altura del rectángulo");
        ...
        jLabel5.setText("El área del rectángulo es");

        jLabel6.setText("El perímetro del rectángulo es");
    ...
    private void bttnCalcualrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttnCalcualrActionPerformed
        ...
        outArea.setText(String.format(df.format(base*altura)));
        outPerimetro.setText(String.format(df.format((base*2) + (altura*2))));
